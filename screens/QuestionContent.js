            ...
            package: [
                {
                    ...
                    questions:
                        [
                            ...
                            { type: "skin1", subtxt: '항목을 선택하세요.', maintxt: 'Q. 보습제를 바르고 2~3시간 이후 양 볼의 피부결은?', question1: '매우 거칠다', question2: '매끄럽다', question3: '윤기가 흐른다' },
                            { type: "skin1", subtxt: '항목을 선택하세요.', maintxt: 'Q. 오후의 피부 상태는 어떤가요?', question1: '각질이 들떠있다', question2: '그대로다', question3: '번들거린다' },
                            { type: "skin1", subtxt: '항목을 선택하세요.', maintxt: 'Q. 화장을 했을 때 피부 상태는?', question1: '항상 각질이 들뜬다', question2: '그대로다', question3: '화장이 촉촉하게 잘 먹는다' },
                ...
                },
                {
                    ...
                    questions:
                        [
                            ...
                            { type: "skin2", subtxt: '항목을 선택하세요.', maintxt: 'Q. 금속이나 악세서리를 착용할 경우 피부 발진이 자주 발생하나요?', question1: '항상 나타난다', question2: '거의 안 나타난다', question3: '전혀 안 나타난다' },
                            ...
                            { type: "skin2", subtxt: '항목을 선택하세요.', maintxt: 'Q. 스크럽이나 딥 클렌징을 하고 나면 피부 상태는?', question1: '많이 따갑다', question2: '약간 따가울 때도 있다', question3: '피부가 좋아진다' },
                ...
                },
                {
                    ...
                    questions:
                        [
                            { type: "skin3", subtxt: '항목을 선택하세요.', maintxt: 'Q. 아침에 일어나면 피부 상태는 어떠한가요?', question1: '번들거린다', question2: '보통이다', question3: '당긴다' },
                            { type: "skin3", subtxt: '항목을 선택하세요.', maintxt: 'Q. 오후의 피부 상태는?', question1: '번들거린다', question2: '그대로다', question3: '당긴다' },
                            { type: "skin3", subtxt: '항목을 선택하세요.', maintxt: 'Q. 얼굴에 붉은 여드름이 발생한 경험이 있나요?', question1: '지금도 있다', question2: '지금도 한번씩 생긴다', question3: '없다' },
                            { type: "skin3", subtxt: '항목을 선택하세요.', maintxt: 'Q. 저녁에 세안은 어떻게 하시나요?', question1: '클렌징과 폼 클렌징', question2: '폼 클렌징', question3: '기타' },
                            { type: "skin3", subtxt: '항목을 선택하세요.', maintxt: 'Q. 모공의 크기는?', question1: '큰 편이다', question2: '보통이다', question3: '작다' },
                            { type: "skin3", subtxt: '항목을 선택하세요.', maintxt: 'Q. 얼굴 피부톤은?', question1: '어두운 편이다', question2: '붉은 편이다', question3: '밝은 편이다' },
                ...
                },
                {
                    ...
                    questions:
                        [
                            { type: "skin4", subtxt: '항목을 선택하세요.', maintxt: 'Q. 얼굴에 색소 침착이 있나요?', question1: '많다', question2: '약간 생긴다', question3: '없다' },
                            { type: "skin4", subtxt: '항목을 선택하세요.', maintxt: 'Q. 원래 피부 색깔은?', question1: '태닝된 피부', question2: ' 약간 태닝된 피부', question3: '희고 핑크색 피부' },
                            { type: "skin4", subtxt: '항목을 선택하세요.', maintxt: 'Q. 얼굴의 점이 햇빛에 의해 짙어지나요?', question1: '많이 짙어진다', question2: '약간 짙어진다', question3: '짙은 점이 없다' },
                            { type: "skin4", subtxt: '항목을 선택하세요.', maintxt: 'Q. 자외선에 노출이 많이 되었을 때 피부의 변화가 있나요?', question1: '피부색이 짙어졌다', question2: '약간 짙어졌다', question3: '약간 붉어졌다' },
                            { type: "skin4", subtxt: '항목을 선택하세요.', maintxt: 'Q. 과거에 얼굴 기미로 진단 받은 적이 있나요?', question1: '있다', question2: '한번 있었지만 소멸되었다', question3: '없다' },
                            { type: "skin4", subtxt: '항목을 선택하세요.', maintxt: 'Q. 상처나 여드름이 없어지지 않고 색소침착이 되는 편인가요?', question1: '항상 그렇다', question2: '때때로 그렇다', question3: '전혀 아니다' },
                ...
                },
                {
                    ...
                    questions:
                        [
                            { type: "skin5", subtxt: '항목을 선택하세요.', maintxt: 'Q. 얼굴을 손가락으로 눌렀을 때 피부 상태는 어떠한가요?', question1: '말랑말랑하다', question2: '탱탱하다', question3: '모르겠다' },
                            { type: "skin5", subtxt: '항목을 선택하세요.', maintxt: 'Q. 나이에 비해 어떻게 보이는 편인가요?', question1: '나이가 많아 보인다', question2: '나이대로 보인다', question3: '젊어 보인다' },
                            { type: "skin5", subtxt: '항목을 선택하세요.', maintxt: 'Q. 하루의 자외선 노출 시간이 얼마나 되나요?', question1: '5시간 이상', question2: '3시간 이상', question3: '거의 안 한다' },
                            { type: "skin5", subtxt: '항목을 선택하세요.', maintxt: 'Q. 눈가 혹은 팔자 주름의 깊이는 어떤가요?', question1: '둘 다 깊다', question2: '하나만 깊다', question3: '주름이 거의 없다' },
                            { type: "skin5", subtxt: '항목을 선택하세요.', maintxt: 'Q. 예전과 비교해서 얼굴 라인이 변한 것 같나요?', question1: '많이 변했다', question2: '조금 변한 것 같다', question3: '거의 그대로다' },
                            { type: "skin5", subtxt: '항목을 선택하세요.', maintxt: 'Q. 화장품을 바르면 흡수가 잘 되나요?', question1: '잘 안 된다', question2: '되는 것 같다', question3: '잘 된다' },
                            { type: "skin5", subtxt: '항목을 선택하세요.', maintxt: 'Q. 예전과 비교해 피부가 얇아졌나요?', question1: '점점 더 얇아지는 것 같다', question2: '원래 얇다', question3: '거의 그대로다' },
