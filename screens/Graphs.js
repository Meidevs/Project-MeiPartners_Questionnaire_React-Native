...
export default class Incomming1 extends React.Component {
    ...
    constructor(props) {
        ...
        // itemList, result, recommend is like a RDMBS;
        // preData has resultCode which is result of questions;
        var itemList = [
            {
        ...
        var catArray = [];
        // Matches result of questions and result array's resultCode;
        ...
        var exArray = [];
        // Each of itemCode like a, b, c gets item's information from itemList;
        itemList.map((data) => {
    ...
    // In the App.js, we declare each of screen's name as cate0 - 6;
    // Parameter is declared at the constructor;
    functions = () => {
